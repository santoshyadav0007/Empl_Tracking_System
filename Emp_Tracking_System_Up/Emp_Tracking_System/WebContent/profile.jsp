...
<div class="signup-form">
        ...
        <div class="form-group">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="emp_addr" value=<%=e.getAddr()%> placeholder="Address" />
			</div>
        </div>
        <div class="form-group">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="emp_mobile" value=<%=e.getMobile()%> placeholder="Mobile"/>
			</div>
        </div>                
        <div class="form-group">
			<div class="input-group">
		...
		<div class="form-group">
			<div class="input-group">
				...
				<input type="password" class="form-control" name="emp_pass" value=<%=e.getPass()%> required="required" placeholder="Password">
			</div>
        </div>
