...
<body style="background-image:url('https://uploads-ssl.webflow.com/5c7e3d44d0f1dfa662c442d0/5dea67c1fdae7b668485b07a_How_Much_Does_Employee_Monitoring_Software_Cost_.png'); background-repeat: no-repeat;
...
<div class="dropdown">
  <button onclick="myFunction()" class="dropbtn"><%=e.getName() %></button>
  <div id="myDropdown" class="dropdown-content">
    <a href="profile.jsp">Profile</a>
    <a href="status.jsp">My Status</a>
